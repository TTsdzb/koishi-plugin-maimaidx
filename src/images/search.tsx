 ...
 */
export function drawSearchResults(musics: MusicInfo[]): h {
 ...
 * @returns Music list image generated by Puppeteer
 */
export function drawSearchResultsWithArtist(musics: MusicInfo[]): h {
  const entries = musics.map((music) => (
    <tr>
      <td style="font-family: torus">{music.id}</td>
      <td>{music.title}</td>
 ...
 * @returns Music list image generated by Puppeteer
 */
export function drawSearchResultsWithCharter(
...
/**
 * Draw a list of music, with music bpm involved.
 * @param musics Music to draw
 * @returns Music list image generated by Puppeteer
 */
export function drawSearchResultsWithBpm(musics: MusicInfo[]): h {
  const entries = musics.map((music) => (
    <tr>
      <td style="font-family: torus">{music.id}</td>
      <td>{music.title}</td>
      <td style="font-family: torus">{music.bpm}</td>
    </tr>
  ));
...
/**
 * Draw a list of music, with chart order and chart base involved.
 * @param musics Corresponding music and chart to draw
 * @returns Music list image generated by Puppeteer
 */
export function drawSearchResultsWithBase(
  musics: { musicInfo: MusicInfo; chart: ChartInfo }[]
): h {
  const entries = musics.map((music) => (
    <tr
    ...
    >
      <td style="font-family: torus">{music.musicInfo.id}</td>
      <td>{music.musicInfo.title}</td>
      <td style="font-family: torus">{music.chart.ds.toFixed(1)}</td>
    </tr>
  ));
